...
class YT_DLP_wrapper:
    ...
    def download_single_query(self,query: Query):
            ...
            with yt_dlp.YoutubeDL(self.ydl_opts) as ydl:
                try:
                    ...
                    json.dump(info, open(f"{self.out_path}info_{query.name}.json", "w"))
    ...
    def batch_download(self, list_of_queries: list[Query], max_workers: int = None):
...
if __name__ == "__main__":
    ...
    downloaded_queries = yt_dlp_wrapper.batch_download(list_queries, 10)
    # downloaded_queries = yt_dlp_wrapper.batch_get_audio_data()
