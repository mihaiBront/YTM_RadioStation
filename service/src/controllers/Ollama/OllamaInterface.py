...
from lib.LanguageModel.OllamaTools.iOllamaTool import OllamaTool
from lib.LanguageModel.OllamaTools.NewsBrowser import NewsBrowser
from lib.LanguageModel.OllamaTools.UrlParser import UrlParser
from lib.LanguageModel.OllamaTools.WebBrowser import WebBrowser
    ...
    def chat(self, user_input: str):
        ...
        if 'message' in response and 'tool_calls' in response['message']:
            ...
            for tool_call in tool_calls:
                log.debug(f"Running tool: {tool_call} with arguments: {tool_call['function']['arguments']}")
...
if __name__ == "__main__":
    ...
    log.info(ollama_interface._OllamaInterface__chat_history[-1]['content'])